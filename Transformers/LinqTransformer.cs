...
{
    public class LinqTransformer : IResultTransformer, IEquatable<LinqTransformer>
    {
        ...
        public LinqTransformer(Func<object[], object> itemTransformation, Func<IEnumerable<object>, object> listTransformation)
        {
        ...
        public bool Equals(LinqTransformer other)
        {
        ...
        {
            return Equals(obj as LinqTransformer);
        }
